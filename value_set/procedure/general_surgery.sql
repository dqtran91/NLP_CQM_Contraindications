/*
 Recreate materialized view for general-surgery procedure codes.
 value set oid: 2.16.840.1.113883.3.117.1.7.1.255
 url: https://vsac.nlm.nih.gov/valueset/2.16.840.1.113883.3.117.1.7.1.255/expansion/
 Code System: ICD-9-PCS
 Inclusion: Includes concepts that represent a procedure for thoracic and abdominal general surgery, except for cardiac procedures.
 ...
 */
DROP MATERIALIZED VIEW IF EXISTS value_set.general_surgery;
CREATE MATERIALIZED VIEW value_set.general_surgery AS
SELECT DISTINCT icd9_code
FROM mimiciii.d_icd_procedures
WHERE icd9_code IN ('0213',
                    '0293',
                    '0406',
                    '0407',
                    '0492',
