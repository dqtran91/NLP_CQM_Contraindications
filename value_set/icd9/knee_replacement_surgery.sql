/*
 Recreate materialized view for knee_replacement_surgery icd9 codes.
 ...
 */
DROP MATERIALIZED VIEW IF EXISTS value_set.knee_replacement_surgery;
CREATE MATERIALIZED VIEW IF NOT EXISTS value_set.knee_replacement_surgery AS
