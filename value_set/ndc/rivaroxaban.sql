/*
 Recreate materialized view for medications that are rivaroxaban.
 ...
 */
DROP MATERIALIZED VIEW IF EXISTS value_set.rivaroxaban;
CREATE MATERIALIZED VIEW IF NOT EXISTS value_set.rivaroxaban AS
