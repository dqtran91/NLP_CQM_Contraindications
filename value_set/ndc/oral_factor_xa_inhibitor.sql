/*
 Recreate materialized view for medications to identify oral factor Xa inhibitors.
 ...
 */
DROP MATERIALIZED VIEW IF EXISTS value_set.oral_factor_xa_inhibitors;
CREATE MATERIALIZED VIEW IF NOT EXISTS value_set.oral_factor_xa_inhibitors AS
