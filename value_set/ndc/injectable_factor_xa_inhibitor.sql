/*
 Recreate materialized view for medications to identify injectable factor Xa inhibitors.
 ...
 */
DROP MATERIALIZED VIEW IF EXISTS value_set.injectable_factor_xa_inhibitors;
CREATE MATERIALIZED VIEW IF NOT EXISTS value_set.injectable_factor_xa_inhibitors AS
