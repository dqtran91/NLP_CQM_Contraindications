...
WHERE (ic.icustay_id IS NULL OR ic.los < 1)                                   -- Exclude ICU stays of 1 day or more
  ...
  AND d.icd9_code NOT IN (SELECT icd9_code FROM mentaldisorders_icd)          -- Exclude mental disorders
  AND d.icd9_code NOT IN (SELECT icd9_code FROM stroke_icd) -- Exclude stroke
;
