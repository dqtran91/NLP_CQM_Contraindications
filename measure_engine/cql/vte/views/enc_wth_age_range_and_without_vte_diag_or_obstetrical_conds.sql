CREATE OR REPLACE VIEW vte.enc_wth_age_range_and_without_vte_diag_or_obstetrical_conds AS
SELECT *
...
COMMENT ON VIEW vte.enc_wth_age_range_and_without_vte_diag_or_obstetrical_conds IS '
