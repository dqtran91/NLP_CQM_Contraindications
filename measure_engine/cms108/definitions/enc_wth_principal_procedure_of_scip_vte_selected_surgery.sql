CREATE OR REPLACE VIEW cms108.enc_wth_principal_procedure_of_scip_vte_selected_surgery AS
SELECT qe.*
...
COMMENT ON VIEW cms108.enc_wth_principal_procedure_of_scip_vte_selected_surgery IS '
