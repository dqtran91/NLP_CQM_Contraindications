CREATE OR REPLACE VIEW cms108.encounter_with_icu_location_stay_one_day_or_more AS
SELECT *
...
Note:
    ...
    Additionaly, 82% of MIMIC-III encounters fits this definition, so this view is not used in this research, because it would be too limiting.';
