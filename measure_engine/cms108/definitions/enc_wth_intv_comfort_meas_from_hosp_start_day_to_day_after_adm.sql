CREATE OR REPLACE VIEW cms108.enc_wth_intv_comfort_meas_from_hosp_start_day_to_day_after_adm AS
SELECT qe.*
...
COMMENT ON VIEW cms108.enc_wth_intv_comfort_meas_from_hosp_start_day_to_day_after_adm IS '
